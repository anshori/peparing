function _displayMapRead (divtarget) {
	...
	var map, isCollapsed, openStreetMaps, Google_Satellite, Google_Terrain;
						...
						var htmlformcomponent = "" +
								"<table id='feature_data' class='table table-condensed table-bordered table-striped'>" +
									...
									"<tbody>" +
										"<tr>" +
											"<td class=''>Desa</td>" +
											"<td class=''>"+feature.properties.dusun+"</td>" +
										"</tr>" +
										"<tr>" +
											"<td class=''>Desa</td>" +
											"<td class=''>"+feature.properties.desa+"</td>" +
										"</tr>" +
										"<tr>" +
											"<td class=''>Kecamatan</td>" +
											"<td class=''>"+feature.properties.kecamatan+"</td>" +
										"</tr>" +
										"<tr>" +
											"<td class=''>Kota/ Kabupaten</td>" +
											"<td class=''>"+feature.properties.kabkot+"</td>" +
										"</tr>" +
										"<tr>" +
										...
										"</tr>" +
										"<tr>" +
											"<td class=''>Lokasi Titik</td>" +
											"<td class=''>"+feature.properties.koordinat_info+"</td>" +
										"</tr>" +
										"<tr>" +
											"<td class=''>Ketinggian</td>" +
											"<td class=''>"+feature.properties.ketinggian+" mdpal</td>" +
										"</tr>" +
										"<tr>" +
											"<td class=''>Foto</td>" +
											"<td class=''><img src='./upload/" + feature.properties.foto_nama + "' width='150' alt='" + feature.properties.foto_nama + "'></td>" +
										"</tr>" +
										"<tr>" +
											"<td class=''>Arah hadap foto</td>" +
											"<td class=''>"+feature.properties.foto_arahhadap+"&#176;</td>" +
										"</tr>" +
										"<tr>" +
											"<td class=''>Informasi foto</td>" +
											"<td class=''>"+feature.properties.foto_info+"</td>" +
										"</tr>" +
										"<tr>" +
											"<td class=''>Menuju lokasi</td>" +
											"<td class=''><a class='btn btn-info btn-sm' href='https://www.google.com/maps/dir/?api=1&destination=" + feature.geometry.coordinates[1] + "," + feature.geometry.coordinates[0] + "&travelmode=driving' role='button' target='_blank'>Buat rute</a></td>" +
										"</tr>" +
									"</tbody>" +
								"</table>" +
								"<table id='feature_data' class='table table-condensed table-bordered table-striped'>" +
									"<thead class='thead-dark'>" +
										"<tr>" +
											"<th colspan='2' class='text-center'>Waktu Kejadian</th>" +
										"</tr>" +
									"</thead>" +
									"<tbody>" +
										"<tr>" +
											"<td class=''>Tanggal</td>" +
											"<td class=''>"+feature.properties.tanggal_kejadian+"</td>" +
										"</tr>" +
										"<tr>" +
											"<td class=''>Jam</td>" +
											"<td class=''>"+feature.properties.jam_kejadian+"</td>" +
										"</tr>" +
										"<tr>" +
											"<td class=''>Hari Pasaran</td>" +
											"<td class=''>"+feature.properties.hari_pasaran+"</td>" +
										"</tr>" +
									"</tbody>" +
									"<caption><small><div class='row' style='color: #55ACEE;'>" +
								    "<div class='col-6'>Tanggal Input Data</div>" +
	...
	promisePoint.then(function (data) {
		...
		map.fitBounds(pointObjects.getBounds());
	});
