...
if (isset($_GET['command'])) {
	if ($_GET['command']=="POLYGON") {
		...
		try {
			...
			$stmt = $dbcon->prepare("INSERT INTO data_polygon(id, enumerator, geom, material_longsor, tipe_batuan, proses_longsor, kecepatan_luncuran, kemiringan_lereng, penggunaanlahan, tipe_vegetasi, penyebab_longsor, panjang_m_longsor, lebar_m_longsor, kedalaman_m_longsor, volume_m3, tanggal_input, tanggal_update) VALUES(UPPER(:id), (:enumerator), ST_GeomFromText(:geometry, 4326), (:material_longsor), (:tipe_batuan), (:proses_longsor), (:kecepatan_luncuran), (:kemiringan_lereng), (:penggunaanlahan), (:tipe_vegetasi), (:penyebab_longsor), (:panjang_m_longsor), (:lebar_m_longsor), (:kedalaman_m_longsor), (:volume_m3), (:tanggal_input), (:tanggal_update))");
